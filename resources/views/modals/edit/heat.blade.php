            ...
            <form class="form-horizontal" onsubmit="return false">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group date">
                                <input type="text" class="date form-control calving_date" name="calving_date" id="edit-heat-calving_date" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group date">
                                <input type="text" class="date form-control heat_date" name="heat_date" id="edit-heat-heat_date" required>
                                <span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
                            </div>
