            ...
            <form class="form-horizontal" id="edit-animal" onsubmit="return false">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group date">
                                <input type="text" class="date form-control filldate-edit-val" name="filldate" id="filldate-edit-val" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group date">
                                <input type="text" name="birthday" class="date form-control birthday" id="birthday-edit-val"
                                       required>
                                <span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <textarea name="bodytext" id="edited-description" class="description-user form-control"></textarea>
