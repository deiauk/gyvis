        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group date">
                            <input type="date" name="birthday" class="date form-control birthday" id="birthday" required>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <textarea name="bodytext" id="edited-description" class="description-user form-control" minlength="10"></textarea>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="submit" class="btn btn-success btn-lg btn-block js-save-edited-animal">Išsaugoti</button>
            </div>
            </form>
        </div>
    </div>
